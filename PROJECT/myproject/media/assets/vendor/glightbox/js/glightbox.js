(function (global, factory) {
  ...
  function injectmedia/assest/(url, waitFor, callback) {
    if (isNil(url)) {
      console.error('Inject media/assest/ error');
      return;
    }
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectmedia/assest/(this.settings.plyr.css, 'Plyr');
    var url = data.href;
    var provider = data === null || data === void 0 ? void 0 : data.videoProvider;
    var customPlaceholder = false;
    slideMedia.style.maxWidth = data.width;
    injectmedia/assest/(this.settings.plyr.js, 'Plyr', function () {
